...
//        guard buildService != nil else { DLog.info( "save failed" ); return }
    ...
    func setControlState() {
        ...
        saveButton.isEnabled = needToSave
        ...
        if let count = buildService?.buildCharacteristics.count , count > 1 {   // Up to one for now
            ...
            newCharacteristicButton.isEnabled = isValid && !needToSave
            addCharacteristicLabel.isEnabled = isValid && !needToSave
        }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toNewCharacteristic" {
            ...
            DLog.debug("dest.buildCharacteristic will be nil")
            ...
            if let indexPaths = collectionView.indexPathsForSelectedItems , indexPaths.count > 0 {
                ...
                DLog.debug("dest.buildCharacteristic will be a BuildCharacteristics instance")
            }
        }
    }
